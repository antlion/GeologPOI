...
public class PoiManager {
	 ...
	 *  
	 * @param poiBase poi su cui � stata fatta la segnalazione
	 ...
	 * @param context contesto dell'attivit� che richiama il servizio
	...
	/**
	 * 
	 * Metodo che richiede tutti i poi di una,o pi� categorie, situati vicino alla posizione dell'utente
	 * 
	 * @param location location in cui si trova l'utente
	 * @param context contesto dell'attivit� che richiede il servizio
