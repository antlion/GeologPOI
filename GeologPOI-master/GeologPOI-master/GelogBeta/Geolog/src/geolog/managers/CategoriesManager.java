 ...
 * sigleton. Questa scelta � dovuto al fatto che le cateogorie non cambiano
 * durante l'esecuzione dell'applicazione. Poich� le categorie devono essere
 * passate a pi� oggetti, non c'� bisogno di istanziarle pi� volte. Inoltre per
 ...
 * necessit� di recuperare di nuovo la lsita delle categorie dal servizio web.
 * 
 * @author Lorenzo
 * 
 */
public class CategoriesManager {
	...
	public Category getCategoryFromId(int idCateogry) {
		...
		return null;
		// ricordare di gestire il caso in cui c'� una nuova categoria
	}
	...
	public void checkMenuCategory(CategoriesAdapter categoryChoose) {
		// Definisco un nuovo array che conterr� le categorie scelte dall'utente
		...
		// rappresenta un valore true,se la cateogoria � stata scelta,false
		// altrimenti.
		...
		// corripondente valore, se � true,lacategoria viene aggiunta alla lista
	 ...
	 * hashMap<Category,String>, dove per ogni categoria c'� un valore che
	 * rappresenta se la categoria � stata selezionata.
	 * 
	 * 
	 * @param listView
	 ...
	 *            selezionate
	 * @param context
	 *            contesto dell'attivit� che chiama il metodo
	 * @param category
	...
	public void setSelectionCategory(ListView listView, Context context,
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// Controlo se la categoria � stata selezionata, se �
